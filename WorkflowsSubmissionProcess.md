...
If you want the newer packaged path, see `Toolkit/README.md` for the skill-first toolkit and shared CLI workflow. This guide remains useful when you want to use `WorkflowReviewChecklist.md` directly with your own LLM and then submit through the existing Exchange flow.

## Using "WorkflowReviewChecklist.md" with AI to review your Workflow

A Markdown file has been created and checked into the Public Repo which contains criteria for Workflow review prior to submission. This file can be provided to your LLM of choice as well as the JSON payload representing your workflow.  
https://github.com/CiscoDevNet/CiscoWorkflowsAutomation/blob/main/WorkflowReviewChecklist.md

The LLM will apply the criteria against your workflow highlighting:
...
restricted in your LLM selection. The LLM will be used against the exported JSON Workflow from your Workspace.
...
If a submission is rejected, which is common, the comments provided will explain the reasons. At this point the developer of the workflow can return to their Workspace, unlock their workflow, and make the necessary edits. When complete, they can submit the workflow again.
